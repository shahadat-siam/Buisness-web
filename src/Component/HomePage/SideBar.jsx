  ...
  return (
    <>
      ...
      <div className=" flex justify-between md:hidden">
        ...
        <button
          className="mobile-menu-button fixed right-0 z-50 py-6 px-4 text-white focus:outline-none focus:bg-transparent"
      ...
      {/* Sidebar */} 
      <div
        className={` md:fixed flex flex-col mt-16 justify-between overflow-x-hidden bg-[#e9defae5] w-64 space-y-6 px-2 py-4 absolute inset-y-0  transform ${
